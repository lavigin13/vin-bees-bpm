...
import { X, ArrowDownCircle, Check, Ban, Package, Users, AlertCircle } from 'lucide-react';
import './CraftingModal.css';

const InboxModal = ({ isOpen, onClose, transfers, onAccept, onReject, pendingRequestsCount, onOpenTeamRequests }) => {
    if (!isOpen) return null;

    const hasRequests = pendingRequestsCount > 0;
